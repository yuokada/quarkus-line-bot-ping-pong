...
with: `./target/quarkus-line-bot-ping-pong-1.0-SNAPSHOT-runner`
...
- AWS Lambda Gateway REST API ([guide](https://quarkus.io/guides/amazon-lambda-http)): Build an API
  Gateway REST API with Lambda integration
...
> :warning: **INCOMPATIBLE WITH DEV MODE**: Amazon Lambda Binding is not compatible with dev mode
> yet!
